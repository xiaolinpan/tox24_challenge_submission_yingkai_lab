...
def mol2graph(smiles_batch: List[str], args: Namespace, prompt: bool) -> BatchMolGraph:
    """
    ...
    """
    mol_graphs = Parallel(n_jobs=10)(delayed(create_mol_graph)(smiles, args, prompt) for smiles in smiles_batch)
